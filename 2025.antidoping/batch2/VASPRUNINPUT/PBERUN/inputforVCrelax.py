    ...
    if os.path.isdir(subfolder_path):  # Ensure it's a directory
        for sub_subfolder in os.listdir(subfolder_path):
            ...
            if os.path.isdir(sub_subfolder_path):  # Check if it's a directory
                ...
                if os.path.exists(poscar_file):  # Check if POSCAR file exists
                    try:
                        ...
                        print(f"INCAR and KPOINTS have been generated for {sub_subfolder_path}")
                    except Exception as e:
                        print(f"Error processing {sub_subfolder_path}: {e}")
                else:
