...
class Ce(VaspInputSet):
    ...
    def __post_init__(self) -> None:
        with MPRester() as m:
            structure = m.get_structure_by_material_id("mp-28")  # Ce
...
parser = argparse.ArgumentParser(
    description="""
    Generate Ce inputs, possibly specifying potentials.
...
inputset = Ce(user_potcar_settings=args.potentials)
