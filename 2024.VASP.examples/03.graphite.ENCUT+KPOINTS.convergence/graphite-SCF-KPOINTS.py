#!/usr/bin/env python3
# [[file:/home/yantar92/Org/notes.org::*Convergence study of graphite vs. ENCUT and KPOINTS][Convergence study of graphite vs. ENCUT and KPOINTS:6]]
"""This is a master vasp running script to converging kpoints for a calculation.
Modified by Ihor Radchenko."""
...
def get_runs(vasp_command, target=1e-4, max_steps=20, mode="linear"):
    ...
    kpoints = [int(kpt) for kpt in kpoints]
    for step in range(max_steps):
        ...
        if step == 0:
            ...
            logging.info(f"KPOINTS = {'x'.join(map(str, map(int, v.kpoints.kpts[0])))} Current energy is {e_per_atom} eV/atom")
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "convergence. E.g., 1e-4 means the KPOINTS will be increased "
...
if __name__ == "__main__":
    main()
# Convergence study of graphite vs. ENCUT and KPOINTS:6 ends here
