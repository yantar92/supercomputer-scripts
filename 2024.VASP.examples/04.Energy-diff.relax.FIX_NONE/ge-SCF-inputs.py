#!/usr/bin/env python3
# [[file:/home/yantar92/Org/notes.org::*ENCUT affect on volume relaxation in Ge, starting from Si lattice (smaller volume)][ENCUT affect on volume relaxation in Ge, starting from Si lattice (smaller volume):5]]
...
if __name__ == "__main__":
    main()
# ENCUT affect on volume relaxation in Ge, starting from Si lattice (smaller volume):5 ends here
