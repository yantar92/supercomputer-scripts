#+TITLE: Data organization on cluster
#+AUTHOR: Ihor Radchenko
#+EMAIL: yantar92@posteo.net

This file describes the folder structure conventions used for organizing VASP simulation data on the supercomputer clusters.
