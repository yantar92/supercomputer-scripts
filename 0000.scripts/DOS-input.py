#!/usr/bin/env python3
# [[file:/home/yantar92/Org/notes.org::*DOS inputs][DOS inputs:1]]
"""Generate VASP inputs for DOS calculation"""
...
def generate_inputs(args) -> None:
    ...
    # see https://www.vasp.at/tutorials/latest/bulk/part1/#bulk-e02
    vasp_input['INCAR']['ISMEAR'] = -5
    vasp_input['INCAR']['LORBIT'] = 11

    directory=f"{system_name}.DOS"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="""
    Generate input files for DOS.

    The input files will be placed into <SYSTEM>.DOS folder.
    """,
